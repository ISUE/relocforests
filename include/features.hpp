...
namespace ISUE {
  namespace RelocForests {
    ...
    public:
      DepthAdaptiveRGB(cv::Point2i offset_1, cv::Point2i offset_2, int color_channel_1, int color_channel_2)
      ...
      static DepthAdaptiveRGB* CreateRandom(Random *random, int image_width, int image_height)
      {
        ...
        return new DepthAdaptiveRGB(offset_1, offset_2, color_channel_1, color_channel_2);
      }
